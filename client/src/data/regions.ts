...
export const REGION_DATA: ProvinceData[] = [
  {
    name: '北京市',
    cities: [
      { name: '北京市', districts: ['东城区', '西城区', '朝阳区', '丰台区', '石景山区', '海淀区', '顺义区', '通州区', '大兴区', '房山区', '门头沟区', '昌平区', '平谷区', '密云区', '怀柔区', '延庆区'] },
    ],
  },
  {
    name: '天津市',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '邢台市', districts: ['襄都区', '信都区', '任泽区', '南和区', '临城县', '内丘县', '柏乡县', '隆尧县', '巨鹿县', '新河县', '广宗县', '平乡县', '威县', '清河县', '临西县', '南宫市', '沙河市'] },
  ...
  },
  {
    name: '香港特别行政区',
    cities: [
      { name: '香港特别行政区', districts: ['中西区', '东区', '九龙城区', '观塘区', '南区', '深水埗区', '黄大仙区', '湾仔区', '油尖旺区', '离岛区', '葵青区', '北区', '西贡区', '沙田区', '屯门区', '大埔区', '荃湾区', '元朗区'] },
    ],
  },
  {
    name: '澳门特别行政区',
    cities: [
      { name: '澳门特别行政区', districts: ['澳门半岛', '氹仔', '路环', '路氹城'] },
    ],
  },
  {
    name: '台湾省',
    cities: [
      ...
      { name: '新北市', districts: ['板桥区', '新庄区', '中和区', '永和区', '土城区', '树林区', '三峡区', '莺歌区', '三重区', '芦洲区', '五股区', '泰山区', '林口区', '八里区', '淡水区', '三芝区', '石门区', '金山区', '万里区', '汐止区', '瑞芳区', '贡寮区', '平溪区', '双溪区', '新店区', '深坑区', '石碇区', '坪林区', '乌来区'] },
      { name: '桃园市', districts: ['桃园区', '中坜区', '平镇区', '八德区', '杨梅区', '芦竹区', '大溪区', '龙潭区', '龟山区', '大园区', '观音区', '新屋区', '复兴区'] },
      { name: '台中市', districts: ['中区', '东区', '西区', '南区', '北区', '西屯区', '南屯区', '北屯区', '丰原区', '大里区', '太平区', '清水区', '沙鹿区', '大甲区', '东势区', '梧栖区', '乌日区', '神冈区', '大肚区', '大雅区', '后里区', '石冈区', '外埔区', '大安区', '雾峰区', '潭子区', '龙井区', '和平区'] },
      ...
      { name: '高雄市', districts: ['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '大寮区', '鸟松区', '林园区', '仁武区', '大树区', '大社区', '冈山区', '路竹区', '桥头区', '梓官区', '弥陀区', '永安区', '燕巢区', '阿莲区', '茄萣区', '湖内区', '旗山区', '美浓区', '内门区', '杉林区', '甲仙区', '六龟区', '茂林区', '桃源区', '那玛夏区'] },
    ],
  },
];
...
export function getProvinces(): string[] {
  return REGION_DATA.map(p => p.name);
}
